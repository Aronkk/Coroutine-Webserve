...
#line 227 "http11_parser.rl"

int http_parser_init(http_parser *parser) {
  int cs = 0;
  
#line 37 "http11_parser.cc"
	{
	cs = http_parser_start;
	}

#line 231 "http11_parser.rl"
  parser->cs = cs;
  parser->body_start = 0;
